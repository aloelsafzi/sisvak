          ...
          <section class="section">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <form class="form form-horizontal" method="POST" action="/TempatVaksinasi/saveData">
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                          <input type="text" id="tempatVaksinasi" class="form-control" name="tempatVaksinasi" placeholder="Tempat Vaksinasi">
                        </div>
                        <div class="col-md-4">
                          <label>Alamat</label>
                        </div>
